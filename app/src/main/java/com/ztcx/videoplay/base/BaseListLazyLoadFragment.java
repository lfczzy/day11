 ...
 * 所有fragment的基类  列表页
 */
public abstract class BaseListLazyLoadFragment<T,BA extends BaseQuickAdapter> extends LazyLoadFragment implements OnLoadMoreListener, OnRefreshListener,BaseQuickAdapter.OnItemClickListener {
