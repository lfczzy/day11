...
import com.ztcx.videoplay.adapter.AnimeAdapter;
 ...
 * 动漫
 */
public class AnimeFragment extends BaseListLazyLoadFragment<Base360Video,AnimeAdapter> {
    ...
    @Override
    protected AnimeAdapter setAdapter() {
        return new AnimeAdapter(R.layout.item_out_tv_play,data);
    }

    @Override
    protected void setUpView() {
        super.setUpView();
//        setVisibleTitleBar(AppConstant.MAIN_COLOR,"动漫");
...
//        refreshLayout.setEnableRefresh(false);
        ...
        adapter.setOnItemLongClickListener(new BaseQuickAdapter.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(BaseQuickAdapter adapter, View view, int position) {
                ButtomDialogView dialogView = new ButtomDialogView(getActivity(),AnimeFragment.this.adapter.getItem(position));
                dialogView.show();
                return true;
            }
        });
...
//               https://www.360kan.com/dongman/list?year=all&area=all&cat=109
    ...
    public void getVideo() {
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                try {
                    themeVideo = GetVideoList.getThemeVideo(HttpConstant.DONGMAN + "?cat="+cat+"&year="+year+"&area="+area+"&pageno="+currentPage);
