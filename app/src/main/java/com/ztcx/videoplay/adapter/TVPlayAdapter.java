...
public class TVPlayAdapter extends BaseQuickAdapter<Base360Video,BaseViewHolder> {
    public TVPlayAdapter(int layoutResId, @Nullable List<Base360Video> data) {
    ...
    protected void convert(BaseViewHolder helper, Base360Video item) {
        ...
        RelativeLayout imageview = helper.getView(R.id.rl_video_image);
