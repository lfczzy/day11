 ...
 *
 */
public class HomeMovieAdapter extends BaseQuickAdapter<Base360Video,BaseViewHolder> {
    public HomeMovieAdapter(int layoutResId, @Nullable List<Base360Video> data) {
    ...
    protected void convert(BaseViewHolder helper, Base360Video item) {
        ...
        paramsImage.height = params.width * 246 / 180;
        ...
        helper.getView(R.id.tv_new_ji).setVisibility(View.GONE);
//        更新集数
