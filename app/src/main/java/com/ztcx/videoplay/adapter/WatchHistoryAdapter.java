...
public class WatchHistoryAdapter extends BaseQuickAdapter<WatchHistory,BaseViewHolder> {
    public WatchHistoryAdapter(int layoutResId, @Nullable List<WatchHistory> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, WatchHistory item) {
