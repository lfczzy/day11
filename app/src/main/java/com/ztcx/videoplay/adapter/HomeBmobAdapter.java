...
public class HomeBmobAdapter extends BaseQuickAdapter<Base360Video,BaseViewHolder> {
    public HomeBmobAdapter(int layoutResId, @Nullable List<Base360Video> data) {
    ...
    protected void convert(BaseViewHolder helper, Base360Video item) {
        ...
        params.width = (int) (MyApp.windowwidth / 2.5) - DisplayTools.dip2px(2,mContext);
        ...
        paramsImage.height = params.width * 322 / 230;
